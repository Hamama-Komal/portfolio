...
/** Shipped apps shown behind the "view more" toggle — lighter cards, no case study. */
export const moreProjects = [
  {
    title: "AI Grammar Checker",
    subtitle: "AI Writing assistant",
    org: "ETOS Way",
    stack: ["Flutter", "AI", "REST APIs"],
  ...
  {
    title: "Voice Notes",
    subtitle: "Diary and memo recorder",
    org: "ETOS Way",
  ...
  },
  {
    ...
    subtitle: "Map-based area measurement",
    org: "ETOS Way",
...
export const stacks = [
  ...
  },
  {
    ...
    icon: "layers",
    accent: "navy",
    blurb: "How I keep apps maintainable.",
    span: "lg:col-span-3",
    items: [
      "Clean Architecture",
      "MVVM",
  ...
  },
  {
    ...
    span: "lg:col-span-2",
    items: ["Firebase", "REST APIs", "Authentication", "Local Storage"],
  },
  {
    title: "Tooling",
    icon: "gitBranch",
    ...
    blurb: "Daily drivers.",
    span: "lg:col-span-2",
    items: ["Git & GitHub", "Android Studio", "VS Code", "Play Console"],
  },
  {
    title: "Also working with",
    icon: "brain",
    accent: "navy",
    blurb: "Alongside the Flutter work.",
    span: "lg:col-span-2",
    items: ["Python", "FastAPI", "LLMs", "RAG"],
  },
];
...
export const accents = {
  azure: {
    ...
    glow: "shadow-[0_0_40px_-12px_rgba(2,125,253,0.55)]",
  ...
  sky: {
    ...
    glow: "shadow-[0_0_40px_-12px_rgba(66,165,245,0.55)]",
    grad: "from-sky-500 to-sky-300",
    rgb: "66,165,245",
  },
  navy: {
    text: "text-azure-700",
    border: "border-azure-700/35",
    glow: "shadow-[0_0_40px_-12px_rgba(1,78,158,0.5)]",
    grad: "from-azure-700 to-azure",
    rgb: "1,78,158",
  },
};
