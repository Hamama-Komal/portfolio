          ...
          <div>
            <Reveal>
              <p className="max-w-2xl border-l-2 border-accent pl-6 font-display text-[1.7rem] leading-[1.25] tracking-tight text-ink sm:text-[2.1rem]">
                Most of these apps were built alone, which means the structure has to hold up
            ...
            <Reveal delay={0.06}>
              <div className="mt-9 grid max-w-2xl gap-5 text-[15px] leading-relaxed text-ink-soft sm:grid-cols-2 sm:gap-8">
                <p>
                  {publishedCount} releases in, that habit is fixed. I pick an architecture at
                  the start and keep to it, because the version of me opening the project six
                  months later to fix a crash report has no context left. Clean architecture, one
                  state management choice per app, dependencies injected rather than reached for.
                </p>
                <p>
                  Teaching keeps that honest. Two evenings a week I explain LLM fundamentals and
                  RAG pipelines to students at XOKSIS, and there is no hiding a half-understood
                  concept in front of a room. The same standard ends up in my pull requests and
                  handover notes.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <p className="mt-8 max-w-2xl text-[15px] leading-relaxed text-ink-soft">
                ...
                users, a team to review against, and the room to own a codebase properly rather
                than only shipping to it.
              </p>
            </Reveal>
          </div>
